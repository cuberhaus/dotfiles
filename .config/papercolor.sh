...
#}#!/bin/sh
# Base16 PaperColor-Light - Shell color setup script
...
color01="89/59/a8" # Base 08 - Red
color02="71/8c/00" # Base 0B - Green
color03="42/71/ae" # Base 0A - Yellow
color04="00/5f/87" # Base 0D - Blue
color05="d7/00/5f" # Base 0E - Magenta
...
color_background="f3/f3/f3" # Base 07
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph f3f3f3 # background
  ...
  printf $printf_template_custom Pm f3f3f3 # cursor text
else
