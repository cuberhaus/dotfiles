#+PROPERTY: header-args:emacs-lisp :tangle (my-tangle-org-file-to-multiple-locations) :mkdirp yes
#+PROPERTY: my-target-files ("~/dotfiles/dotfiles/.config/my_emacs/init.el" "~/repos/WinDotfiles/home/dot_emacs.d/init.el")
#+title Emacs!
#+STARTUP: overview
~code~
=verbatim=
